...
public class Main {
    ...
    public static void main(String[] args)
    {
        ...
        SequenceDiagramGenerator sequenceDiagramGenerator = new SequenceDiagramGenerator(ParserType.REFLECTION);            // Instantiate a class that can create a plantUML sequence diagram
